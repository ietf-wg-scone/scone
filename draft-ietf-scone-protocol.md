...
SCONE provides a means for networks to signal the maximum achievable throughput,
...
it might apply rate limiting using congestion control signals.
...
The throughput advice is not authenticated.  Any signal
